<div class="warehouses index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $warehouse['Warehouse']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $warehouse['Warehouse']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
