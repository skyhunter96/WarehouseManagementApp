<div class="serviceProducts index">
	...
	<fieldset>
		<legend><?php echo __('Search Service Products') ?></legend>
		<?php
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($serviceProduct['Item']['name'], array('action' => 'view', $serviceProduct['ServiceProduct']['id'])); ?>
		</td>
		...
		<td><?php if($serviceProduct['ServiceProduct']['is_for_distributors']) echo "Yes"; else echo "No" ?>&nbsp;</td>
		<td><?php echo h($serviceProduct['ServiceProduct']['status']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $serviceProduct['ServiceProduct']['id'])); ?>
